...
public class ScoreAPI {
	...
	public static HashMap<String, ScoreAPI> allScoreBoards = new HashMap<>();
	...
	public ScoreAPI(List<Player> player) {
		...
		for (Player loopPlayer : player) {
			...
			scoreboards.put(loopPlayer, new ScoreHolder(loopPlayer, scoreboard, objective));
		}
	}
	...
	public HashMap<Player, ScoreHolder> getScoreboards() {
		return scoreboards;
	}
}
