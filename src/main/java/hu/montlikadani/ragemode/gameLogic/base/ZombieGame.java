...
public class ZombieGame extends BaseGame {
	...
	private final IZombieSpawner zombieSpawnerManager;

	public ZombieGame(@org.jetbrains.annotations.NotNull String name) {
		super(name, GameType.APOCALYPSE);

		zombieSpawnerManager = new hu.montlikadani.ragemode.gameLogic.base.zombieSpawn.ZombieSpawnerManager(rm, this);
	}

	public IZombieSpawner getZombieSpawnerManager() {
